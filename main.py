...
bg = pygame.image.load('img/logo1.jpg').convert()
game_bg = pygame.image.load('img/logo2.jpg').convert()

main_font = pygame.font.Font('font/font.ttf', 35)
font = pygame.font.Font('font/font.ttf', 30)

title_tetris = main_font.render('GAME_TETRIS', True, pygame.Color('darkorange'))
